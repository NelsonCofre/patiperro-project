package com.patiperro.chat.exception;
...
/**
 * Respuestas JSON {@code { "message": "..." }} alineadas con reserva-service y el front del chat.
 */
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, String>> handleValidation(MethodArgumentNotValidException ex) {
		...
		return ResponseEntity.badRequest()
				.body(Map.of("message", msg.isEmpty() ? "Validación fallida" : msg));
	}

	@ExceptionHandler(MaxUploadSizeExceededException.class)
	public ResponseEntity<Map<String, String>> handleMaxUploadSize(MaxUploadSizeExceededException ex) {
		return ResponseEntity.badRequest()
				.body(Map.of("message", ChatMediaStorageService.MSG_VALIDACION_IMAGEN));
	}
